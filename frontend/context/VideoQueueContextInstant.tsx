...
export const VideoQueueProvider = ({ children }: { children: ReactNode }) => {
    ...
    return (
        <VideoQueueContext.Provider value={{ videoRef,canvasRef,isQueueEmpty, reset, queue, addVideo, popVideo, currentVideo, updateVideo, updateRefs, handleVideoLoaded, isLoading, currentFrame, fps: FPS, isReversed: isReversedRef.current, framesLength: frames.length, getTotalVideoDuration }}>
            {children}
